...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mpa.sovereign'
        db.add_column(u'mpa_mpa', 'sovereign',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)


        # Changing field 'Mpa.country'
        db.alter_column(u'mpa_mpa', 'country', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):
        # Deleting field 'Mpa.sovereign'
        db.delete_column(u'mpa_mpa', 'sovereign')


        # Changing field 'Mpa.country'
        db.alter_column(u'mpa_mpa', 'country', self.gf('django.db.models.fields.CharField')(max_length=20))
    ...
    models = {
        ...
        u'mpa.mpa': {
            ...
            'sovereign': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
