...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('mpa_contact', 'email', self.gf('django.db.models.fields.EmailField')(max_length=500, null=True, blank=True), keep_default=False)

        # Adding field 'Contact.phone'
        db.add_column('mpa_contact', 'phone', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True), keep_default=False)

        # Changing field 'Contact.url'
        db.alter_column('mpa_contact', 'url', self.gf('django.db.models.fields.URLField')(max_length=500, null=True))

        # Changing field 'Contact.address'
        db.alter_column('mpa_contact', 'address', self.gf('tinymce.models.HTMLField')(null=True))

        # Changing field 'MpaCandidate.geom_smerc'
        db.alter_column('mpa_mpacandidate', 'geom_smerc', self.gf('django.contrib.gis.db.models.fields.MultiPointField')(srid=3857, null=True))

        # Changing field 'Mpa.summary'
        db.alter_column('mpa_mpa', 'summary', self.gf('tinymce.models.HTMLField')(null=True))

        # Changing field 'WikiArticle.summary'
        db.alter_column('mpa_wikiarticle', 'summary', self.gf('tinymce.models.HTMLField')(null=True))


    def backwards(self, orm):
        
        # Deleting field 'Contact.email'
        db.delete_column('mpa_contact', 'email')

        # Deleting field 'Contact.phone'
        db.delete_column('mpa_contact', 'phone')

        # Changing field 'Contact.url'
        db.alter_column('mpa_contact', 'url', self.gf('django.db.models.fields.URLField')(default='', max_length=500))

        # Changing field 'Contact.address'
        db.alter_column('mpa_contact', 'address', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'MpaCandidate.geom_smerc'
        db.alter_column('mpa_mpacandidate', 'geom_smerc', self.gf('django.contrib.gis.db.models.fields.MultiPointField')(srid=900913, null=True))

        # Changing field 'Mpa.summary'
        db.alter_column('mpa_mpa', 'summary', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'WikiArticle.summary'
        db.alter_column('mpa_wikiarticle', 'summary', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 23, 9, 19, 47, 641787)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 23, 9, 19, 47, 641683)'}),
