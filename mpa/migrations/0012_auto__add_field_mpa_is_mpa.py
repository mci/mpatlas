...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mpa.is_mpa'
        db.add_column(u'mpa_mpa', 'is_mpa',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Mpa.is_mpa'
        db.delete_column(u'mpa_mpa', 'is_mpa')
    ...
    models = {
        ...
        u'mpa.mpa': {
            ...
            'is_mpa': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
