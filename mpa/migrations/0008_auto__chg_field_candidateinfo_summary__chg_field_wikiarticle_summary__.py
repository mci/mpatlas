...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CandidateInfo.summary'
        db.alter_column(u'mpa_candidateinfo', 'summary', self.gf('ckeditor.fields.RichTextField')(null=True))

        # Changing field 'WikiArticle.summary'
        db.alter_column(u'mpa_wikiarticle', 'summary', self.gf('ckeditor.fields.RichTextField')(null=True))

        # Changing field 'MpaCandidate.geog'
        db.alter_column(u'mpa_mpacandidate', 'geog', self.gf('django.contrib.gis.db.models.fields.MultiPointField')(null=True, geography=True))

        # Changing field 'Mpa.summary'
        db.alter_column(u'mpa_mpa', 'summary', self.gf('ckeditor.fields.RichTextField')(null=True))

        # Changing field 'Mpa.simple_geog'
        db.alter_column(u'mpa_mpa', 'simple_geog', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(null=True, geography=True))

        # Changing field 'Mpa.geog'
        db.alter_column(u'mpa_mpa', 'geog', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(null=True, geography=True))

        # Changing field 'Mpa.point_geog'
        db.alter_column(u'mpa_mpa', 'point_geog', self.gf('django.contrib.gis.db.models.fields.MultiPointField')(null=True, geography=True))

    def backwards(self, orm):

        # Changing field 'CandidateInfo.summary'
        db.alter_column(u'mpa_candidateinfo', 'summary', self.gf('tinymce.models.HTMLField')(null=True))

        # Changing field 'WikiArticle.summary'
        db.alter_column(u'mpa_wikiarticle', 'summary', self.gf('tinymce.models.HTMLField')(null=True))

        # Changing field 'MpaCandidate.geog'
        db.alter_column(u'mpa_mpacandidate', 'geog', self.gf('django.contrib.gis.db.models.fields.MultiPointField')(null=True))

        # Changing field 'Mpa.summary'
        db.alter_column(u'mpa_mpa', 'summary', self.gf('tinymce.models.HTMLField')(null=True))

        # Changing field 'Mpa.simple_geog'
        db.alter_column(u'mpa_mpa', 'simple_geog', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(null=True))

        # Changing field 'Mpa.geog'
        db.alter_column(u'mpa_mpa', 'geog', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(null=True))

        # Changing field 'Mpa.point_geog'
        db.alter_column(u'mpa_mpa', 'point_geog', self.gf('django.contrib.gis.db.models.fields.MultiPointField')(null=True))
