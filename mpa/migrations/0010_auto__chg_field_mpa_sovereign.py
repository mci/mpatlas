...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Mpa.sovereign'
        db.alter_column(u'mpa_mpa', 'sovereign', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'Mpa.sovereign'
        db.alter_column(u'mpa_mpa', 'sovereign', self.gf('django.db.models.fields.CharField')(default=None, max_length=50))
