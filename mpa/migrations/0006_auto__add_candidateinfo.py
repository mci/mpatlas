...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CandidateInfo'
        db.create_table('mpa_candidateinfo', (
            ...
            ('source', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True)),
            ('scope', self.gf('django.db.models.fields.CharField')(default='Site', max_length=250, null=True, blank=True)),
            ('basin', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('region', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('location', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True)),
            ('eez_or_highseas', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True)),
            ('lead_organization', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True)),
            ('partner_organizations', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True)),
            ('key_agency_or_leader', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True)),
            ('timeframe', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True)),
            ('current_protection', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True)),
            ('desired_protection', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True)),
            ('importance', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True)),
            ('opportunity', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True)),
            ('references', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True)),
        ))
        db.send_create_signal('mpa', ['CandidateInfo'])


    def backwards(self, orm):
        
        # Deleting model 'CandidateInfo'
        db.delete_table('mpa_candidateinfo')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 23, 9, 39, 6, 307281)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 23, 9, 39, 6, 307192)'}),
        ...
        'mpa.contact': {
            ...
            'address': ('tinymce.models.HTMLField', [], {'null': 'True', 'blank': 'True'}),
