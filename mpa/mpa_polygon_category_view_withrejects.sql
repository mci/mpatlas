DROP VIEW public.mpa_polygon_category_view_withrejects;

CREATE OR REPLACE VIEW public.mpa_polygon_category_view_withrejects
AS SELECT m.mpa_id,
    m.geom,
    g.categories,
    m.wdpa_id,
    ...
    m.cons_obj_wdpa,
    m.supp_info_wdpa,
    m.fishing_protection_details::TEXT,
    m.fishing_protection_level,
    m.protection_mpaguide_details::TEXT,
    m.protection_mpaguide_level,
    m.protection_rbcs_details::TEXT,
   ...
   FROM mpa_mpa m,
    ( SELECT n.mpa_id,
          ...
          GROUP BY n.mpa_id
          ORDER BY n.mpa_id) g
  WHERE m.geom IS NOT NULL AND m.is_point = false AND m.mpa_id = g.mpa_id
  ORDER BY m.mpa_id DESC;
 
 -- Rules and Triggers
CREATE OR REPLACE RULE mpa_polygon_category_view_withrejects_INSERT as
    ON INSERT TO mpa_polygon_category_view_withrejects DO INSTEAD
    INSERT INTO mpa_mpa 
    (geom,
    wdpa_id,
    wdpa_pid,
    ...
    NEW.verified_by,
    NEW.verify_wdpa,
    NEW.datasources::JSONB,
    NEW.conservation_focus_info,
    NEW.access_info,
    NEW.cons_obj_wdpa,
    NEW.supp_info_wdpa,
    NEW.fishing_protection_details::JSONB,
    NEW.fishing_protection_level,
    NEW.protection_mpaguide_details::JSONB,
    NEW.protection_mpaguide_level,
    NEW.protection_rbcs_details::JSONB,
    NEW.protection_rbcs_level,
    NEW.protection_rbcs_level_name);

CREATE OR REPLACE RULE mpa_polygon_category_view_withrejects_UPDATE AS
    ON UPDATE TO mpa_polygon_category_view_withrejects DO INSTEAD
    UPDATE mpa_mpa
    SET
        (mpa_id,
        geom,
...
CREATE OR REPLACE RULE mpa_polygon_category_view_withrejects_DELETE as
    ON DELETE TO mpa_polygon_category_view_withrejects DO INSTEAD
     DELETE FROM mpa_mpa
     WHERE mpa_id=OLD.mpa_id;

-- Permissions

ALTER TABLE public.mpa_polygon_category_view_withrejects OWNER TO mpatlas;
GRANT ALL ON TABLE public.mpa_polygon_category_view_withrejects TO mpatlas;
