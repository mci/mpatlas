...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Meow.lat_zone'
        db.delete_column('spatialdata_meow', 'lat_zone')

        # Adding field 'Meow.latitude_zone'
        db.add_column('spatialdata_meow', 'latitude_zone', self.gf('django.db.models.fields.CharField')(default=-999, max_length=10), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Meow.lat_zone'
        db.add_column('spatialdata_meow', 'lat_zone', self.gf('django.db.models.fields.CharField')(default=-999, max_length=10), keep_default=False)

        # Deleting field 'Meow.latitude_zone'
        db.delete_column('spatialdata_meow', 'latitude_zone')
