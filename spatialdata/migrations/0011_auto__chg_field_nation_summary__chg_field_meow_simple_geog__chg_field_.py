...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Nation.summary'
        db.alter_column(u'spatialdata_nation', 'summary', self.gf('ckeditor.fields.RichTextField')(null=True))

        # Changing field 'Meow.simple_geog'
        db.alter_column(u'spatialdata_meow', 'simple_geog', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(null=True, geography=True))

        # Changing field 'Meow.geog'
        db.alter_column(u'spatialdata_meow', 'geog', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(null=True, geography=True))

        # Changing field 'Eez.simple_geog'
        db.alter_column(u'spatialdata_eez', 'simple_geog', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(null=True, geography=True))

        # Changing field 'Eez.geog'
        db.alter_column(u'spatialdata_eez', 'geog', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(null=True, geography=True))

    def backwards(self, orm):

        # Changing field 'Nation.summary'
        db.alter_column(u'spatialdata_nation', 'summary', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Meow.simple_geog'
        db.alter_column(u'spatialdata_meow', 'simple_geog', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(null=True))

        # Changing field 'Meow.geog'
        db.alter_column(u'spatialdata_meow', 'geog', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(null=True))

        # Changing field 'Eez.simple_geog'
        db.alter_column(u'spatialdata_eez', 'simple_geog', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(null=True))

        # Changing field 'Eez.geog'
        db.alter_column(u'spatialdata_eez', 'geog', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(null=True))
