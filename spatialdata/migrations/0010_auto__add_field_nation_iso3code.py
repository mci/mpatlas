...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Nation.iso3code'
        db.add_column('spatialdata_nation', 'iso3code', self.gf('django.db.models.fields.CharField')(default='', max_length=3), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Nation.iso3code'
        db.delete_column('spatialdata_nation', 'iso3code')
