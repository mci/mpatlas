...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Nation.geom_smerc'
        db.add_column(u'spatialdata_nation', 'geom_smerc',
                      self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(srid=3857, null=True),
                      keep_default=False)

        # Adding field 'Nation.geom'
        db.add_column(u'spatialdata_nation', 'geom',
                      self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(null=True),
                      keep_default=False)

        # Adding field 'Nation.geog'
        db.add_column(u'spatialdata_nation', 'geog',
                      self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(null=True, geography=True),
                      keep_default=False)

        # Adding field 'Nation.simple_geom_smerc'
        db.add_column(u'spatialdata_nation', 'simple_geom_smerc',
                      self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(srid=3857, null=True),
                      keep_default=False)

        # Adding field 'Nation.simple_geom'
        db.add_column(u'spatialdata_nation', 'simple_geom',
                      self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(null=True),
                      keep_default=False)

        # Adding field 'Nation.simple_geog'
        db.add_column(u'spatialdata_nation', 'simple_geog',
                      self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(null=True, geography=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Nation.geom_smerc'
        db.delete_column(u'spatialdata_nation', 'geom_smerc')

        # Deleting field 'Nation.geom'
        db.delete_column(u'spatialdata_nation', 'geom')

        # Deleting field 'Nation.geog'
        db.delete_column(u'spatialdata_nation', 'geog')

        # Deleting field 'Nation.simple_geom_smerc'
        db.delete_column(u'spatialdata_nation', 'simple_geom_smerc')

        # Deleting field 'Nation.simple_geom'
        db.delete_column(u'spatialdata_nation', 'simple_geom')

        # Deleting field 'Nation.simple_geog'
        db.delete_column(u'spatialdata_nation', 'simple_geog')
