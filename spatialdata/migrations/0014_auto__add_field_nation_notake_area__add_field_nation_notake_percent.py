...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Nation.notake_area'
        db.add_column(u'spatialdata_nation', 'notake_area',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Nation.notake_percent'
        db.add_column(u'spatialdata_nation', 'notake_percent',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Nation.notake_area'
        db.delete_column(u'spatialdata_nation', 'notake_area')

        # Deleting field 'Nation.notake_percent'
        db.delete_column(u'spatialdata_nation', 'notake_percent')
    ...
    models = {
        ...
        u'spatialdata.nation': {
            ...
            'notake_area': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'notake_percent': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'simple_geog': ('django.contrib.gis.db.models.fields.MultiPolygonField', [], {'null': 'True', 'geography': 'True'}),
            'simple_geom': ('django.contrib.gis.db.models.fields.MultiPolygonField', [], {'null': 'True'}),
            'simple_geom_smerc': ('django.contrib.gis.db.models.fields.MultiPolygonField', [], {'srid': '3857', 'null': 'True'}),
            'summary': ('ckeditor.fields.RichTextField', [], {'null': 'True', 'blank': 'True'})
