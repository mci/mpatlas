...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Nation'
        db.create_table('spatialdata_nation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=240)),
            ('summary', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('spatialdata', ['Nation'])

        # Adding field 'Eez.nation'
        db.add_column('spatialdata_eez', 'nation', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['spatialdata.Nation'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Nation'
        db.delete_table('spatialdata_nation')

        # Deleting field 'Eez.nation'
        db.delete_column('spatialdata_eez', 'nation_id')
