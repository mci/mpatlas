...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('spatialdata_eezmembership', (
            ...
            ('mpa', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wdpa.WdpaPolygon'])),
            ('area_in_eez', self.gf('django.db.models.fields.FloatField')()),
        ))
    ...
    models = {
        ...
        'spatialdata.eezmembership': {
            ...
            'area_in_eez': ('django.db.models.fields.FloatField', [], {}),
