...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Meow'
        db.create_table('spatialdata_meow', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('eco_code', self.gf('django.db.models.fields.FloatField')()),
            ('ecoregion', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('prov_code', self.gf('django.db.models.fields.FloatField')()),
            ('province', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('rlm_code', self.gf('django.db.models.fields.FloatField')()),
            ('realm', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('alt_code', self.gf('django.db.models.fields.FloatField')()),
            ('eco_code_x', self.gf('django.db.models.fields.FloatField')()),
        ...
        db.send_create_signal('spatialdata', ['Meow'])


    def backwards(self, orm):
        
        # Deleting model 'Meow'
        db.delete_table('spatialdata_meow')
    ...
    models = {
        ...
        'spatialdata.meow': {
            ...
            'eco_code': ('django.db.models.fields.FloatField', [], {}),
            'eco_code_x': ('django.db.models.fields.FloatField', [], {}),
