...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Meow.simple_geom_smerc'
        db.alter_column('spatialdata_meow', 'simple_geom_smerc', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(srid=3857, null=True))

        # Changing field 'Meow.geom_smerc'
        db.alter_column('spatialdata_meow', 'geom_smerc', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(srid=3857, null=True))

        # Changing field 'Eez.simple_geom_smerc'
        db.alter_column('spatialdata_eez', 'simple_geom_smerc', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(srid=3857, null=True))

        # Changing field 'Eez.geom_smerc'
        db.alter_column('spatialdata_eez', 'geom_smerc', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(srid=3857, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Meow.simple_geom_smerc'
        db.alter_column('spatialdata_meow', 'simple_geom_smerc', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(srid=900913, null=True))

        # Changing field 'Meow.geom_smerc'
        db.alter_column('spatialdata_meow', 'geom_smerc', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(srid=900913, null=True))

        # Changing field 'Eez.simple_geom_smerc'
        db.alter_column('spatialdata_eez', 'simple_geom_smerc', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(srid=900913, null=True))

        # Changing field 'Eez.geom_smerc'
        db.alter_column('spatialdata_eez', 'geom_smerc', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(srid=900913, null=True))
    ...
    models = {
        'mpa.contact': {
            ...
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '500'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'phone': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
