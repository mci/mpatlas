...
MPAtlas.prototype.init = function(map) {
    var mpatlas = this;
...
MPAtlas.prototype.resizeViewport = function() {
    $('#body_full').height($(window).height() - $('#header_full').height() - $('#footer_full').height());
    this.map.invalidateSize();
};

MPAtlas.prototype.makeMap = function() {
...
MPAtlas.prototype.initMapTip = function() {
...
MPAtlas.prototype.toggleMapTipEvents = function(respond_to_events) {
    var maptip = this.maptip;
...
MPAtlas.prototype.registerMapHover = function() {
    var maptip = this.maptip;
    var handlers = {
...
MPAtlas.prototype.initMapHover = function(delay, pixeltolerance) {
    var map = this.map,
...
MPAtlas.prototype.getPixelRadius = function(pxradius) {
    ...
    console.log(this.map.getSize(), bounds, resolution, (resolution * pxradius) / 1000)
	return (resolution * pxradius) / 1000;
};

MPAtlas.prototype.initLayerSlider = function() {
