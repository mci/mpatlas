							...
							case 'mpas':
								...
								$.ajax({
									...
									success: function (data) {
										...
										for (i = 0; i < len; i++) {
											mpa = data.mpas[i];
											mpahtml += '<a class="maptip_mpalink" href="' + mpatlas.domain + 'maps/sites/' + mpa.id + '/"><span style="float:right; margin-left:3px; font-style:italic;">(' + mpa.country + ')</span>' + mpa.name + '</a>';
										}
