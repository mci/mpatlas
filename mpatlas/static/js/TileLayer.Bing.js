L.TileLayer.Bing = L.TileLayer.extend({
    ...
    attributionTemplate: '<span style="display:inline-block">' + '<a target="_blank" href="http://www.bing.com/maps/">' + '<img src="{logo}" /></a><br><span>{copyrights}' + '<a style="white-space: nowrap" target="_blank" ' + 'href="http://www.microsoft.com/maps/product/terms.html">' + 'Terms of Use</a></span></span>',
    ...
    _loadMetadata: function() {
        ...
        var params = {
            ...
            url = "http://dev.virtualearth.net/REST/v1/Imagery/Metadata/" + this._mapType + L.Util.getParamString(params),
    ...
    _updateAttribution: function() {
        if (this._map.attributionControl) {
            ...
            this._map.attributionControl.removeAttribution(this.attribution);
            this.attribution = this.attributionTemplate.replace('{logo}', metadata.brandLogoUri).replace('{copyrights}', copyrights);
...
L.TileLayer.Bing.processMetadata = function(metadata) {
    ...
    var res = metadata.resourceSets[0].resources[0],
        ...
        i = 0,
        j, provider, bbox, script = document.getElementById(this._callbackId);
