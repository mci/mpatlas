  ...
  L.VectorGrid = L.GridLayer.extend({
    ...
    setFeatureStyle: function(id, layerStyle) {
      ...
      for (var tileKey in this._vectorTiles) {
        ...
        if (data) {
          ...
          styleOptions = (styleOptions instanceof Function) ? styleOptions(feat.properties, tile.getCoord().z) : styleOptions;
    ...
    resetFeatureStyle: function(id) {
      ...
      for (var tileKey in this._vectorTiles) {
        ...
        if (data) {
          var feat = data.feature;
          var layerStyle = this.options.vectorTileLayerStyles[data.layerName] || L.Path.prototype.options;
          var styleOptions = (layerStyle instanceof Function) ? layerStyle(feat.properties, tile.getCoord().z) : layerStyle;
          this._updateStyles(feat, tile, styleOptions);
        }
      }
    },
