...
(function(Buffer) {
  var test = require('tape'),
      ...
      VectorTile = require('../index').VectorTile,
      VectorTileLayer = require('../index').VectorTileLayer,
      VectorTileFeature = require('../index').VectorTileFeature;
  ...
  test('parsing vector tiles', function(t) {
    ...
    t.test('should have all layers', function(t) {
      ...
      t.deepEqual(Object.keys(tile.layers), ['landuse', 'waterway', 'water', 'barrier_line', 'building', 'landuse_overlay', 'tunnel', 'road', 'bridge', 'place_label', 'water_label', 'poi_label', 'road_label', 'waterway_label']);
      t.end();
    });
    t.test('should extract the tags of a feature', function(t) {
      ...
      t.deepEqual(park.loadGeometry(), [[{
        x: 3898,
        y: 1731
      }]]);
      t.deepEqual(tile.layers.road.feature(656).loadGeometry(), [[{
        x: 1988,
        y: 306
      }, {
        x: 1808,
    ...
    t.test('toGeoJSON', function(t) {
      ...
      t.ok(approximateDeepEqual(tile.layers.building.feature(0).toGeoJSON(8801, 5371, 14), {
        type: 'Feature',
        id: 1000267229912,
        properties: {osm_id: 1000267229912},
        geometry: {
          type: 'Polygon',
          coordinates: [[[13.392285704612732, 52.54974045706258], [13.392264246940613, 52.549737195107554], [13.392248153686523, 52.549737195107554], [13.392248153686523, 52.54974045706258], [13.392285704612732, 52.54974045706258]]]
        }
      }));
