  ...
  (function(window) {
    ...
    (function() {
      ...
      if (urlParams.maxDepth) {
        config.maxDepth = parseInt(urlParams.maxDepth, 10) === -1 ? Number.POSITIVE_INFINITY : urlParams.maxDepth;
      }
      config.testId = [];
      if (urlParams.testId) {
    ...
    if (typeof window !== "undefined") {
      ...
      (function() {
        var i,
            l,
            keys = ["test", "module", "expect", "asyncTest", "start", "stop", "ok", "notOk", "equal", "notEqual", "propEqual", "notPropEqual", "deepEqual", "notDeepEqual", "strictEqual", "notStrictEqual", "throws"];
    ...
    DiffMatchPatch.prototype.diffCleanupEfficiency = function(diffs) {
      ...
      while (pointer < diffs.length) {
        if (diffs[pointer][0] === DIFF_EQUAL) {
          ...
          if (lastequality && ((preIns && preDel && postIns && postDel) || ((lastequality.length < this.DiffEditCost / 2) && (preIns + preDel + postIns + postDel) === 3))) {
