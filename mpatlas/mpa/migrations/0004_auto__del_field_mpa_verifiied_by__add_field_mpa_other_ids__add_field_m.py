...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Mpa.verifiied_by'
        db.delete_column('mpa_mpa', 'verifiied_by')

        # Adding field 'Mpa.other_ids'
        db.add_column('mpa_mpa', 'other_ids', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True), keep_default=False)

        # Adding field 'Mpa.verification_reason'
        db.add_column('mpa_mpa', 'verification_reason', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True), keep_default=False)

        # Adding field 'Mpa.verified_by'
        db.add_column('mpa_mpa', 'verified_by', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Changing field 'Mpa.verification_state'
        db.alter_column('mpa_mpa', 'verification_state', self.gf('django.db.models.fields.CharField')(max_length=100))


    def backwards(self, orm):
        
        # Adding field 'Mpa.verifiied_by'
        db.add_column('mpa_mpa', 'verifiied_by', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Deleting field 'Mpa.other_ids'
        db.delete_column('mpa_mpa', 'other_ids')

        # Deleting field 'Mpa.verification_reason'
        db.delete_column('mpa_mpa', 'verification_reason')

        # Deleting field 'Mpa.verified_by'
        db.delete_column('mpa_mpa', 'verified_by')

        # Changing field 'Mpa.verification_state'
        db.alter_column('mpa_mpa', 'verification_state', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 18, 15, 47, 34, 305125)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 18, 15, 47, 34, 305015)'}),
