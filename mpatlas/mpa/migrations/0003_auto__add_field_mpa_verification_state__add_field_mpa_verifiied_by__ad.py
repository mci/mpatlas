...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Mpa.verification_state'
        db.add_column('mpa_mpa', 'verification_state', self.gf('django.db.models.fields.CharField')(default='Unverified', max_length=100, null=True, blank=True), keep_default=False)
        ...
        # Adding field 'Mpa.verified_date'
        db.add_column('mpa_mpa', 'verified_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Mpa.verification_state'
        db.delete_column('mpa_mpa', 'verification_state')

        # Deleting field 'Mpa.verifiied_by'
        db.delete_column('mpa_mpa', 'verifiied_by')

        # Deleting field 'Mpa.verified_date'
        db.delete_column('mpa_mpa', 'verified_date')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 18, 13, 20, 52, 541099)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 18, 13, 20, 52, 540784)'}),
        ...
        'mpa.mpa': {
            ...
            'verification_state': ('django.db.models.fields.CharField', [], {'default': "'Unverified'", 'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'verified_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'verifiied_by': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
