...
def process():
    ...
    updatelist = []
    existingrevisions = {}
    with open('/home/mpatlas/wdpa2018_removed.json', 'r') as removefile:
        removelist = json.load(removefile)
    with open('/home/mpatlas/wdpa2018_added.json', 'r') as addfile:
        addlist = json.load(addfile)
    with open('/home/mpatlas/wdpa2018_updated.json', 'r') as updatefile:
        updatelist = json.load(updatefile)
    with open('/home/mpatlas/wdpa2018_dataconflicts.json', 'r') as existingfile:
